...
function View(){
	...
	this.elems.artist = $('.playing .autor')
		...
		this.model.setSongs([
			{
				name: 'Santo',
				artist: 'Bethel',
				src: 'media/Santo - Cuarteto de Voces.mp3',
				img: "img/songs/santo.jpg"
			},
			{
				name: 'Rayo Fugaz',
				artist: 'Bethel',
				src: 'media/RAYO FUGAZ - ANDREA Y NICOLÁS I BETHEL PRODUCCIONES.mp3',
				img: "img/songs/rayofugaz.jpg"
			},
			{
				name: 'God IS',
				artist: 'Holy Starr',
				src: 'media/God Is (Official Music Video) - Christian Singer Holly Starr- New Christian Music Video.mp3',
				img: "img/songs/god-is.jpg"
			}
		])
